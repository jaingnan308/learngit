			...
			tools : [{
				...
				handler : function() {
					...
					if (tab.panel('options').closable) {
						...
						$.messager.alert('提示', '[' + tab.panel('options').title + ']不可以被关闭！', 'warning');
					}
				}
			} ]
		});
...
<body id="mainLayout" class="easyui-layout" style="background-color:#FDFFFF;">
	<div data-options="region:'north',href:'<%=contextPath%>/securityJsp/north.jsp'" style="height: 70px; overflow: hidden;background-color:#FDFFFF;" class="logo" ></div>
	<div data-options="region:'west',href:'',split:true" title="导航" style="width: 200px; padding: 10px;background-color:#FDFFFF;">
		<ul id="mainMenu"></ul>
	</div>
	<div data-options="region:'center'" style="overflow: hidden;background-color:#FDFFFF">
		<div id="mainTabs">
			<div title="我的日程" data-options="iconCls:'ext-icon-heart'" style="background-color:#FDFFFF;">
				<iframe src="<%=contextPath%>/securityJsp/calendar.jsp" allowTransparency="true" style="border: 0; width: 85%; height: 99%;" frameBorder="0"></iframe>
			</div>
		</div>
	</div>
