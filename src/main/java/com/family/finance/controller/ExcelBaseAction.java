...
public class ExcelBaseAction {
	...
	public static void exportFile(HttpServletResponse response, HttpServletRequest request, File file, boolean isDel) {
		response.reset();
		...
		try {
			...
			} else if ((fileType.toLowerCase().endsWith("xls")) || (fileType.toLowerCase().endsWith("csv"))) {
				response.setContentType("application/ms-excel ");
			} else if (fileType.toLowerCase().endsWith("pdf")) {
				response.setContentType("application/pdf");
			} else if (fileType.toLowerCase().endsWith("jpg") || fileType.toLowerCase().endsWith("jpeg")
	 ...
	 * @param in
	 */
	public static void downLoadFtpFile(HttpServletRequest request, HttpServletResponse response, InputStream in,
